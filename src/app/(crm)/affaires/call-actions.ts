...
/** Calls rattachés à une affaire, du plus récent au plus ancien. */
...
/**
 * Rattache un call en attente à une affaire choisie par l'utilisateur.
 *
 * La ligne quitte la file et rejoint l'historique de l'affaire : c'est la même
 * table que les calls rattachés automatiquement, donc les compteurs et les
 * analyses n'ont pas à distinguer les deux origines.
 */
export async function resolvePendingCall(inboxId: string, dealId: string): Promise<ActionResult> {
